...
import { ITreeItemRaw } from "../types";
...
export interface ITreeViewSelectionChangeEvent {
     ...
     * Selected elements.
     */
    readonly selection: ITreeItemRaw[];
}
...
export interface ITreeViewHandle<T> {
   ...
   */
     ...
     */
    reveal(element: ITreeItemRaw, options?: { select?: boolean, focus?: boolean, expand?: boolean | number }): Promise<void>;
